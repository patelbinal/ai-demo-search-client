...
// import { UserContext, SearchResponse } from '@/types/search';
...
//     try {
//       const response = await fetchSearchResults(query, userContext, { page: 1, pageSize: 20 });
        ...
        prev
          ? {
              ...
              results: {
                ...
                purchases: [
                  ...prev.results.purchases,
                  ...response.results.purchases,
                ],
                transports: [
                  ...prev.results.transports,
                  ...response.results.transports,
                ],
              },
            }
          : response
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t border-border bg-card mt-auto">
        <div className="container mx-auto px-4 py-4">
          <p className="text-sm text-muted-foreground text-center">
            Centralized Search Platform • Role-based filtering enforced on
            backend
          </p>
        </div>
      </footer>
